...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_D = torch.optim.Adam(itertools.chain(self.netD_B.parameters(), self.netD_C.parameters()), lr=opt.lr, betas=(opt.beta1, 0.999))
    ...
    def backward_D_B(self):
        ...
        self.loss_D_B = self.backward_D_basic(self.netD_B, self.real_B, self.fake_B_temp)
    ...
    def backward_G(self):
        ...
        # Identity loss
        #if lambda_idt > 0:
        if lambda_idt == "this should never run":
        ...
        # GAN loss D_A(G_A(A))
        self.loss_G_A = self.criterionGAN(self.netD_B(self.fake_B), True) + self.criterionGAN(self.netD_C(self.fake_B), True)
